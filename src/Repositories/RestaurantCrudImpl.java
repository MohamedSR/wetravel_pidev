...
public class RestaurantCrudImpl implements RestaurantCrudInterface {
    ...
    @Override
    public void createWithImage(Restaurant restaurants) throws SQLException {
        String req = "INSERT INTO restaurants ( name, capacity, adresse, ville, pays,image) VALUES(?,?,?,?,?,?)";
        ...
        prs.setString(6, restaurants.getImage());
        prs.executeUpdate();
    }
    @Override
